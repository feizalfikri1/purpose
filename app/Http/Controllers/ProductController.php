...
public function store(Request $request)
{
    ...
    if ($request->hasFile('image')) {
        ...
        //KEMUDIAN NAMA FILENYA KITA BUAT CUSTOMER DENGAN PERPADUAN TIME DAN SLUG DARI NAMA product. ADAPUN EXTENSIONNYA KITA GUNAKAN BAWAAN FILE TERSEBUT
        ...
        //SETELAH FILE TERSEBUT DISIMPAN, KITA SIMPAN INFORMASI productNYA KEDALAM DATABASE
...
{
    $product = Product::find($id); //QUERY UNTUK MENGAMBIL DATA product BERDASARKAN ID
    //HAPUS FILE IMAGE DARI STORAGE PATH DIIKUTI DENGNA NAMA IMAGE YANG DIAMBIL DARI DATABASE
    File::delete(storage_path('app/public/products/' . $product->image));
    //KEMUDIAN HAPUS DATA product DARI DATABASE
    $product->delete();
